...
import 'package:fyp_calendar_2/ui/auto_schedule_page.dart';
...
class _CalendarScreenState extends State<CalendarScreen> {
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          FloatingActionButton(
            heroTag: "btn4",
            onPressed: () async {
              await Get.to(() => AutoSchedulePage(tasks: _taskController.taskList));
            },
            child: const Icon(
              Icons.schedule,
              color: Colors.pinkAccent,
  ...
  void _addTaskToList() async {
    ...
    _todaysEvents.clear();
    print("Here is first _todarEvents list: $_todaysEvents");
